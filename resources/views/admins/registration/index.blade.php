<x-dashboard-layout>
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Admin
                                    Management</span>
                            </div>
                        </li>
                    </ol>
    ...
    @if (request()->user()->is_SuperAdmin())
                ...
                <div class="space-y-4">
                    <div>
                        <label for="photo"
                            ...
                            (Note: Only png,jpg,jpeg allowed!)</label>
        ...
        <div id="drawer-create-default"
            ...
            <form action="{{ route('admin.registration.store') }}" class="create-form" enctype="multipart/form-data">
                <div class="space-y-4">
                    <div>
                        <label for="photo"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Photo
