<x-dashboard-layout>
        ...
        <form class="update-form">
            <div class="space-y-4">
                <div>
                    ...
                    <textarea name="ques" id="ques" rows="5" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">{!! old('ques') !!}</textarea>
                    <span class="text-red-600"></span>
                </div>
                <div>
                    <label for="ans"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Answer</label>
                    <textarea name="ans" id="ans" rows="5" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">{!! old('ans') !!}</textarea>
                    <span class="text-red-600"></span>
                </div>
    ...
    <div id="drawer-create-default"
        ...
        <button type="button" onclick="hideCreateDrawer()" aria-controls="drawer-create-default"
            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
        ...
        <form action="{{ route('admin.faq.store') }}" class="create-form">
            <div class="space-y-4">
                <div>
                    <label for="ques" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Question</label>
                    <textarea name="ques" id="ques" rows="5" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">{!! old('ques') !!}</textarea>
            ...
            var table = $('#dataTable').DataTable({
                columns: [{
                    ...
                    },
                    {
                        data: 'ans',
                        name: 'ans',
                        className: 'p-4 text-base text-gray-900 break-words dark:text-white',
                        orderable: false,
                    },
                    {
                        data: 'action',
