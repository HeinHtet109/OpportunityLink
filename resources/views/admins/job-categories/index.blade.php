<x-dashboard-layout>
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                    aria-current="page">Job Categories</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                        ...
                        placeholder="Type job category title" />
                    <span class="text-red-600"></span>
                </div>
                <div>
                    <label for="icon"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Icon (Note: Only png allowed!)</label>
    ...
    <div id="drawer-create-default"
        ...
        <form action="{{ route('admin.job-category.store') }}" class="create-form" enctype="multipart/form-data">
            <div class="space-y-4">
                <div>
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Title</label>
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
