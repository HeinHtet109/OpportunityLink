<x-app-layout>
    <section>
        <div class="mx-auto px-8 md:px-32 py-12 max-w-7xl">
            <div class="mx-auto lg:max-w-none max-w-3xl space-y-2">
                <div class="pb-5 border-b max-w-xl">
                    <h2 class="text-slate-900 text-3xl font-normal tracking-tighter lg:text-4xl mt-8">
            ...
            <div
                class="hover:prose-a:text-slate-900 mt-24 prose prose-a:text-accent-500 prose-blockquote:border-l-black prose-blockquote:text-slate-500 prose-code:text-slate-900 prose-headings:font-semibold prose-headings:text-slate-900 prose-li:marker:text-accent-500 text-slate-500 prose-pre:border max-w-none">
                <h1>Terms of Service</h1>
                <p><em>Last updated: January 6, 2023</em></p>
                <p>
                    ...
                    Lexington products every day. Because we don’t know every one of
                    our customers personally, we have to put in place some Terms of Service
                    to help keep the ship afloat.
                </p>
                <p>
                    When we say “Company”, “we”, “our”,
                    or “us” in this document, we are referring to Lexington LLC.
                    We spun off Highrise HQ, LLC in the past, but it has since rejoined
                    Lexington LLC.
                </p>
                <p>
                    When we say “Services”, we mean our websites, including
                    lexington.com, hola.com, and Lexington.com, and any product created and
                    maintained by Lexington LLC. That includes lexington (all versions),
                    hola, Highrise, Campfire, Backpack, Ta-da List, and Writeboard, whether
                    delivered within a web browser, desktop application, mobile application,
                    or another format.
                </p>
                <p>
                    When we say “You” or “your”, we are referring to
                    the people or organizations that own an account with one or more of our
                    Services. We have specific ownership policies for our products:
                    lexington 4, lexington 2, lexington Classic, hola for Domains, Highrise,
                    Campfire and Backpack.
                </p>
                <p>
                    We may update these Terms of Service ("Terms") in the future. You can
                    track all changes made since mid-2018 on GitHub. Typically these changes
                    have been to clarify some of these terms by linking to an expanded
                    related policy. Whenever we make a significant change to our policies,
                    we will refresh the date at the top of this page and take any other
                    appropriate steps to notify account holders.
                </p>
                <p>
                    ...
                    waiving that right or provision. <strong>These Terms do contain a limitation of our liability.
                    </strong></p>
                <p>
                ...
                <ol>
                    <li>
                        ...
                        users set up two-factor authentication for added security. In some of
                        our Services, we may require it.
                    </li>
                    <li>
                        You may not use the Services for any purpose outlined in our Use
                        Restrictions policy, and you may not permit any of your users to do
                        so, either.
                    </li>
                    <li>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        authorities. See our Taxes policy for more details. Otherwise, you are
                ...
                <ol>
                    <li>
                        ...
                        account in our Cancellation policy. An email or phone request to
                        cancel your account is not automatically considered cancellation. If
                        you need help canceling your account, you can always contact our
                        Support team.
                    </li>
                    <li>
                        ...
                        provided instructions for hola, lexington 4, lexington 2, lexington
                        Classic, Highrise, Campfire, and Backpack.
                    </li>
                    <li>
                ...
                <ol>
                    <li>
                        ...
                        permanently, any part of our Services with or without notice.
                    </li>
                    <li>
                ...
                <ol>
                    <li>
                        ...
                        Services on an “as is” and “as available”
                        basis. We do not offer service-level agreements for most of our
                        Services — here’s the one exception — but do take
                        uptime of our applications seriously. Visit https://www.37status.com
                        to see the status of our Services.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        our Security Overview for full details and our Security Response page
                        for how to report a security incident or threat.
                    </li>
                    <li>
                        <p>
                        ...
                        <ul>
                            <li><strong>To help you with support requests you make.</strong> We’ll
                                ask for express consent before accessing your account.
                            </li>
                            <li><strong>On the rare occasions when an error occurs that stops an
                                    automated process partway through. We get automated alerts when
                                    such errors occur. When we can fix the issue and restart
                                    automated processing without looking at any personal data, we
                                    do. In rare cases, we have to look at a minimum amount of
                                    personal data to fix the issue. In these rare cases, we aim to
                                    fix the root cause to prevent the errors from recurring.
                                </strong></li>
                            <li><strong>To safeguard Lexington.</strong> We’ll look at logs and
                                metadata as part of our work to ensure the security of your data and
                                the Services as a whole. If necessary, we may also access accounts
                                as part of an abuse report investigation.
                            </li>
                            <li><strong>To the extent required by applicable law.</strong> As a US
                    ...
                    <li>
                        <p>
                            ...
                            subprocessors who handle personal data for lexington, hola,
                            Highrise, Campfire, and Backpack, as well as a list of Company
                            processors.
                        </p>
                    </li>
                    <li>
                        Under the California Consumer Privacy Act (“CCPA”),
                        Lexington is a “service provider”, not a
                        “business” or “third party”, with respect to
                        ...
                        these Terms, the Privacy policy, and other policies. We do not retain,
                    ...
                    <li>
                        These Terms incorporate the Lexington Data Processing Addendum
                        (“DPA”) when the EU General Data Protection Regulation
                        (“GDPR”) or United Kingdom General Data Protection
                        Regulation (“UK GDPR”) applies to your use of Lexington
                        Services to process Customer Data as defined in the DPA. The DPA
                        linked above supersedes any previously agreed data processing addendum
                        between you and Lexington LLC relating to your use of the Lexington
                        Services.
                    </li>
                </ol>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        Company’s logos or any Service logos for promotional purposes.
                        Please email us requests to use logos. We reserve the right to rescind
                        any permissions if you violate these Terms.
                    </li>
                    <li>
                ...
                <p>
                    ...
                    our Services (currently lexington, Highrise, Campfire, and Backpack).
                    Any use of the API, including through a third-party product that
                    accesses the Services, is bound by these Terms plus the following
                    specific terms:
                </p>
                <ol>
                    <li>
                    ...
                    <li>
                        ...
                        a Service user’s activity <em>other than time tracking</em>,
                    ...
                    <li>
                        ...
                        need to suspend your account’s access, we will attempt to warn
                ...
                <p>
                    ...
                    lexington at https://lexington.com/extras and for Highrise at
                    https://highrisehq.com/extras. We are not liable or accountable for any
                ...
                <p><strong><em>You expressly understand and agree that the Company shall not be
                ...
                <p>
                    ...
                    bet on us. If the bet does not work out, that’s on you, not us. We
