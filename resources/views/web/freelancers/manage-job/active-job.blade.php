                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Manage Active
                                    Jobs</span>
                            </div>
                        </li>
                    </ol>
                    ...
                    <div class="sm:pr-3">
                        ...
                        <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                            <input type="search" id="dataTables_filter"
                                ...
                                placeholder="Search for active jobs" />
                        </div>
                    </div>
        ...
        <script type="module">
            var table = $('#dataTable').DataTable({
                columns: [{
                    ...
                    {
                        data: 'employer',
                        name: 'employer.employerProfile.company_name',
                        className: 'p-4 text-base font-medium text-gray-900 break-words dark:text-white',
                         orderable: false,
                    },
                    {
