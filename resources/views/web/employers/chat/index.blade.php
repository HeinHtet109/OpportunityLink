                ...
                <nav class="flex mb-5" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li class="flex items-center">
                            <a href="{{ route('web.employers.managejob.activeJob.index') }}"
                                class="inline-flex items-center text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-white">
                ...
                <div class="items-center justify-between block sm:flex">
                    <div class="flex items-center mb-4 sm:mb-0">
                        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
                            Chat with freelancer here!
                        </h1>
                    </div>

                    @if ($activeJob->status == ONGOING && $activeJob->employer_end == false)
                    ...
                    @if ($activeJob->status == ONGOING && $activeJob->freelancer_end == false && $activeJob->employer_end == true)
                        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                            <div
            ...
            <div class="shadow">
                ...
                <div class="w-full border flex flex-col">
                    ...
                    <div class="py-2 px-3  flex flex-row justify-between items-center border-b">
                        <div class="flex items-center">
                            <div>
                                <img class="w-10 h-10 rounded-full" src="{{ $activeJob->freelancer->photo }}" />
                            </div>
                            <div class="ml-4">
                                <p class=" text-slate-800 font-bold dark:text-white">
                                    {{ $activeJob->freelancer->name }}
                                </p>
                                <p class="text-grey-darker text-xs mt-1 dark:text-white">
                                    Contact Number: {{ $activeJob->freelancer->phone }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex mr-3">
                            <div class="ml-6">
                                <a href="mailto:{{ $activeJob->freelancer->email }}">
                        ...
                        <div class="px-4 py-4 flex items-center">
                            <div class="flex-1 mx-4">
                                <div class="flex items-center p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                                    ...
                                    <div>
                                        This Job is already ended! No longer send messages to your freelancer, if you have any issues, don't hesitate to contact us! Thank you!
                                    </div>
                                </div>
                            </div>
                        </div>
                    @else
                        <form action="{{ route('web.employers.chat.message.send') }}" method="POST" id="SendMessage">
                            @csrf

                            <input type="hidden" name="active_job_id" value="{{ $activeJob->id }}">
                            <input type="hidden" name="user_id" value="{{ request()->user()->id }}">
                            <input type="hidden" name="receiver_id" value="{{ $activeJob->freelancer_id }}">
    ...
    <div id="end-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <form action="{{ route('web.employers.managejob.activeJob.end') }}" method="POST">
                    @csrf
    ...
    <div id="rating-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        Please submit rating for your freelancer! Your rating is useful to improve better performance in
                        working environment.
                    </p>
                    ...
                    <form action="{{ route('web.employers.managejob.activeJob.submit-rating') }}" method="POST"
